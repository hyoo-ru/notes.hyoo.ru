...
;
	($.$mol_icon_filter_remove) = class $mol_icon_filter_remove extends ($.$mol_icon) {
		path(){
...
;
	($.$hyoo_notes) = class $hyoo_notes extends ($.$mol_book2) {
		Theme(){
		...
		notes_page_tools(){
			return [(this.Reminders()), (this.Tag_archived())];
		}
		note_filter(next){
			if(next !== undefined) return next;
			return "";
		...
		Note_add(){
			...
			(obj.click) = (next) => ((this.note_add_long(next)));
			return obj;
		}
		Notes_page_add(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Notes_filter()), (this.Note_add())]);
			return obj;
		}
		note_rows(){
			return [];
		...
		Notes_page_content(){
			const obj = new this.$.$mol_list();
			(obj.rows) = () => ([(this.Notes_page_add()), (this.Notes_list())]);
			return obj;
		}
		note_current_title(){
			return "";
		...
		Note_content(){
			...
			(obj.value) = (next) => ((this.note_current_content(next)));
			return obj;
		}
		tagging_title(){
			return "$hyoo_notes";
		...
		Tagging_add(){
			...
			(obj.sub) = () => ([(this.Tagging_add_icon())]);
			(obj.click) = (next) => ((this.tagging_add(next)));
			return obj;
		}
		tagging_tools(){
			return [(this.Tagging_filter()), (this.Tagging_add())];
		}
		Tagging_tools(){
			const obj = new this.$.$mol_view();
		...
		Tagging_content(){
			const obj = new this.$.$mol_list();
			(obj.rows) = () => ([(this.Tagging_tools()), (this.Tagging_list())]);
			return obj;
		}
		note_title(id){
			return "";
		...
		Note_moment(id){
			const obj = new this.$.$mol_paragraph();
			(obj.sub) = () => ([(this.note_moment_view(id))]);
			return obj;
		}
		id(id){
			return "";
		...
		tagging_tag_row(id){
			return [(this.Tag_link(id)), (this.Tag_toggle(id))];
		}
		plugins(){
			return [(this.Theme())];
		}
		...
		Notes_page(id){
			...
			(obj.body) = () => ([(this.Notes_page_content())]);
			return obj;
		}
		Note_page(id){
			const obj = new this.$.$mol_page();
		...
		Tagging_page(){
			...
			(obj.body) = () => ([(this.Tagging_content())]);
			return obj;
		}
		Note_row(id){
			const obj = new this.$.$mol_link();
			(obj.sub) = () => ([(this.Note_title(id)), (this.Note_moment(id))]);
			(obj.arg) = () => ({"note": (this.id(id))});
			return obj;
		}
		Tagging_tag_row(id){
			const obj = new this.$.$mol_view();
	...
	($mol_mem(($.$hyoo_notes.prototype), "Theme"));
	($mol_mem(($.$hyoo_notes.prototype), "Reminders"));
	($mol_mem(($.$hyoo_notes.prototype), "tag_archived"));
	($mol_mem(($.$hyoo_notes.prototype), "Tag_archived_icon"));
	($mol_mem(($.$hyoo_notes.prototype), "Tag_archived"));
	($mol_mem(($.$hyoo_notes.prototype), "note_filter"));
	($mol_mem(($.$hyoo_notes.prototype), "note_add_short"));
	($mol_mem(($.$hyoo_notes.prototype), "Notes_filter"));
	($mol_mem(($.$hyoo_notes.prototype), "Note_add_icon"));
	($mol_mem(($.$hyoo_notes.prototype), "note_add_long"));
	($mol_mem(($.$hyoo_notes.prototype), "Note_add"));
	($mol_mem(($.$hyoo_notes.prototype), "Notes_page_add"));
	($mol_mem(($.$hyoo_notes.prototype), "Notes_list"));
	($mol_mem(($.$hyoo_notes.prototype), "Notes_page_content"));
	($mol_mem(($.$hyoo_notes.prototype), "note_archived"));
	($mol_mem(($.$hyoo_notes.prototype), "Note_archived_icon"));
	($mol_mem(($.$hyoo_notes.prototype), "Note_archived"));
	($mol_mem(($.$hyoo_notes.prototype), "note_current_moment"));
	($mol_mem(($.$hyoo_notes.prototype), "Note_date"));
	($mol_mem(($.$hyoo_notes.prototype), "Note_close_icon"));
	($mol_mem(($.$hyoo_notes.prototype), "Note_close"));
	($mol_mem(($.$hyoo_notes.prototype), "note_current_content"));
	($mol_mem(($.$hyoo_notes.prototype), "Note_content"));
	($mol_mem(($.$hyoo_notes.prototype), "Tags_all_icon"));
	($mol_mem(($.$hyoo_notes.prototype), "Tags_all"));
	($mol_mem(($.$hyoo_notes.prototype), "Source_link"));
	($mol_mem(($.$hyoo_notes.prototype), "Lights"));
	($mol_mem(($.$hyoo_notes.prototype), "tagging_filter"));
	($mol_mem(($.$hyoo_notes.prototype), "tagging_add"));
	($mol_mem(($.$hyoo_notes.prototype), "Tagging_filter"));
	($mol_mem(($.$hyoo_notes.prototype), "Tagging_add_icon"));
	($mol_mem(($.$hyoo_notes.prototype), "Tagging_add"));
	($mol_mem(($.$hyoo_notes.prototype), "Tagging_tools"));
	($mol_mem(($.$hyoo_notes.prototype), "Tagging_list"));
	($mol_mem(($.$hyoo_notes.prototype), "Tagging_content"));
	($mol_mem_key(($.$hyoo_notes.prototype), "Note_title"));
	($mol_mem_key(($.$hyoo_notes.prototype), "Note_moment"));
	($mol_mem_key(($.$hyoo_notes.prototype), "Tag_title"));
	($mol_mem_key(($.$hyoo_notes.prototype), "Tag_link"));
	($mol_mem_key(($.$hyoo_notes.prototype), "Tag_toggle_icon"));
	($mol_mem_key(($.$hyoo_notes.prototype), "tagging_tag"));
	($mol_mem_key(($.$hyoo_notes.prototype), "Tag_toggle"));
	($mol_mem_key(($.$hyoo_notes.prototype), "Notes_page"));
	($mol_mem_key(($.$hyoo_notes.prototype), "Note_page"));
	($mol_mem(($.$hyoo_notes.prototype), "Tagging_page"));
	($mol_mem_key(($.$hyoo_notes.prototype), "Note_row"));
	($mol_mem_key(($.$hyoo_notes.prototype), "Tagging_tag_row"));
...
(function ($) {
    class $mol_notify {
        ...
        static async request_permissions() {
            return new Promise(done => Notification.requestPermission(perm => {
                done(perm);
            }));
        }
        static show(info) {
    ...
    if (typeof window === 'undefined') {
        self.addEventListener('message', async (event) => {
            ...
            await $mol_service().showNotification(title, { body, data, tag });
        });
