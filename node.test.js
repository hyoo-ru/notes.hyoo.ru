...
(function ($) {
    class $mol_icon_card_text_outline extends $.$mol_icon {
         ...
         **/
        path() {
            return "M20,20H4C2.9,20 2,19.1 2,18V6C2,4.9 2.9,4 4,4H20C21.1,4 22,4.9 22,6V18C22,19.1 21.1,20 20,20M4,6V18H20V6H4M6,9H18V11H6V9M6,13H16V15H6V13Z";
        }
    }
    $.$mol_icon_card_text_outline = $mol_icon_card_text_outline;
})($ || ($ = {}));
...
(function ($) {
    class $hyoo_notes extends $.$mol_book {
         ...
         **/
        pages() {
            return [].concat(this.Tags_page(), this.Notes_page(), this.Note_page(), this.Tagging_page());
        }
        /**
         *  ```
         *  Tags_page $mol_page
        ...
        Tags_page() {
            return ((obj) => {
                ...
                obj.tools = () => [].concat(this.Tags_all());
         ...
         **/
        tags_title() {
            return this.$.$mol_locale.text("$hyoo_notes_tags_title");
        }
        /**
         *  ```
         *  Tags_all $mol_link
        ...
        Tags_all() {
            return ((obj) => {
                ...
                obj.sub = () => [].concat(this.Tags_all_icon());
                return obj;
            })(new this.$.$mol_link());
        }
        /**
         ...
         **/
        tags_body() {
            return [].concat(this.Tag_filter(), this.Tag_add(), this.Tag_list());
        }
        /**
         *  ```
        ...
        Tag_add() {
            return ((obj) => {
                obj.sub = () => [].concat(this.Tag_add_icon(), this.tag_add_title());
                obj.click = (event) => this.tag_add(event);
                return obj;
            })(new this.$.$mol_button_minor());
        }
        /**
        ...
        Notes_page() {
            return ((obj) => {
                obj.minimal_width = () => 500;
                obj.title = () => this.notes_title();
                obj.event_top = (val) => this.event_front_up(val);
                obj.tools = () => [].concat(this.Note_add());
        ...
        Note_add() {
            return ((obj) => {
                obj.sub = () => [].concat(this.Note_add_icon());
         ...
         **/
        notes_body() {
            return [].concat(this.Note_filter(), this.Notes_list(), this.Tag_drop());
        }
        /**
         *  ```
        ...
        Note_add_hint() {
            return ((obj) => {
                obj.sub = () => [].concat(this.notes_list_add_title(), this.Notes_list_add_icon());
                return obj;
            })(new this.$.$mol_view());
        }
        /**
        ...
        Notes_list_add_icon() {
            return ((obj) => {
                return obj;
            })(new this.$.$mol_icon_arrow_up_bold());
        }
        /**
         *  ```
        ...
        Note_page() {
            return ((obj) => {
                ...
                obj.event_top = (val) => this.event_front_up(val);
                obj.tools = () => [].concat(this.Note_tags_manage(), this.Note_close());
                obj.body = () => [].concat(this.Note_content());
                return obj;
            })(new this.$.$mol_page());
        }
        /**
        ...
        Note_tags_manage() {
            return ((obj) => {
                obj.sub = () => [].concat(this.Note_tags_manage_icon());
                obj.arg = () => ({
                    "tagging": "",
                });
                return obj;
        ...
        Note_close() {
            return ((obj) => {
                ...
                obj.sub = () => [].concat(this.Note_close_icon());
                return obj;
            })(new this.$.$mol_link());
        }
        /**
         ...
         *  ```
         **/
        note_current_content(val, force) {
            return (val !== void 0) ? val : "";
        }
        /**
         *  ```
        ...
        Tagging_page() {
            return ((obj) => {
                ...
                obj.event_top = (val) => this.event_front_up(val);
                obj.tools = () => [].concat(this.Tagging_close());
         ...
         **/
        tagging_title() {
            return this.$.$mol_locale.text("$hyoo_notes_tagging_title");
        }
        /**
         *  ```
        ...
        Tagging_close() {
            return ((obj) => {
                ...
                obj.sub = () => [].concat(this.Tagging_close_icon());
                return obj;
            })(new this.$.$mol_link());
        }
        /**
         ...
         **/
        tagging_body() {
            return [].concat(this.Tagging_filter(), this.Tagging_add(), this.Tagging_list(), this.Note_drop());
        }
        /**
         *  ```
        ...
        Tagging_add() {
            return ((obj) => {
                obj.sub = () => [].concat(this.Tagging_add_icon(), this.tag_add_title());
        ...
        Note_drop() {
            return ((obj) => {
                obj.title = () => this.note_drop_title();
                obj.click = (event) => this.note_drop(event);
                return obj;
            })(new this.$.$mol_button_minor());
        }
        /**
         ...
         **/
        note_drop_title() {
            return this.$.$mol_locale.text("$hyoo_notes_note_drop_title");
        }
        /**
         *  ```
        ...
        Tag_row(id) {
            return ((obj) => {
                obj.sub = () => [].concat(this.Tag_icon(id), this.Tag_title(id));
                obj.arg = () => ({
                    "tag": this.id(id),
                    "note": null,
                    "tagging": null,
        ...
        Note_row(id) {
            return ((obj) => {
                obj.sub = () => [].concat(this.Note_icon(id), this.Note_title(id));
                obj.arg = () => ({
                    "note": this.id(id),
                    "tagging": null,
                });
        ...
        Note_icon(id) {
            return ((obj) => {
                return obj;
            })(new this.$.$mol_icon_card_text_outline());
        }
        /**
         *  ```
        ...
        Tagging_tag_row(id) {
            return ((obj) => {
                ...
                obj.label = () => [].concat(this.Tagging_tag_title(id));
                return obj;
    ...
    __decorate([
        $.$mol_mem
    ], $hyoo_notes.prototype, "Tag_filter", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_notes.prototype, "tag_filter", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_notes.prototype, "Tag_add", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_notes.prototype, "Tag_add_icon", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_notes.prototype, "tag_add", null);
    __decorate([
    ...
    __decorate([
        $.$mol_mem
    ], $hyoo_notes.prototype, "Note_add_hint", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_notes.prototype, "Notes_list_add_icon", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_notes.prototype, "Tag_drop", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_notes.prototype, "tag_drop", null);
    __decorate([
    ...
    __decorate([
        $.$mol_mem
    ], $hyoo_notes.prototype, "Note_tags_manage", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_notes.prototype, "Note_tags_manage_icon", null);
    __decorate([
        $.$mol_mem
    ...
    __decorate([
        $.$mol_mem
    ], $hyoo_notes.prototype, "Tagging_close", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_notes.prototype, "Tagging_close_icon", null);
    __decorate([
        $.$mol_mem
    ...
    __decorate([
        $.$mol_mem
    ], $hyoo_notes.prototype, "Note_drop", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_notes.prototype, "note_drop", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_notes.prototype, "Placeholder", null);
    __decorate([
        $.$mol_mem_key
    ], $hyoo_notes.prototype, "Tag_row", null);
    __decorate([
        $.$mol_mem_key
    ], $hyoo_notes.prototype, "Tag_icon", null);
    __decorate([
        $.$mol_mem_key
    ...
    __decorate([
        $.$mol_mem_key
    ], $hyoo_notes.prototype, "Note_icon", null);
    __decorate([
        $.$mol_mem_key
    ...
    __decorate([
        $.$mol_mem_key
    ], $hyoo_notes.prototype, "Tagging_tag_title", null);
